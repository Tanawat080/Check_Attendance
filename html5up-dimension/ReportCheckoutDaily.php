...
if (!$_SESSION["uname"]) {  //check session
    ...
    <?php echo($_SESSION['userID']); ?><br>
                ...
                $time = date("G:i:s");
                if($time < '15:30:00') {
                  echo "<center><h3>กรุณาออกรายงานหลังเลิกเรียน</h3></center>";
                }else{
                ?>
            <center><h3><font color='#003366'>รายงานการออกโรงเรียน</font></h3></center>
            <div class="table-responsive">
                <table class="table" width="800" border="1" align="center" bordercolor="#666666" >
                    <tr>
                        <td width="150" align="center" bgcolor="#CCCCCC"><strong><font color='#003366'>รหัสนักเรียน</font></strong></td>
                        ...
                        <td width="200" align="center" bgcolor="#CCCCCC"><strong><font color='#003366'>ออกโรงเรียน</font></strong></td>
                    </tr>
    <?php
//connect db
    ...
    $strSLQ2 = "SELECT * from checkinout,student,typecheckout,class where `dateCheckInOut` = '".$date."'
    and student.studentID=checkinout.studentID and student.classID='".$objResult['classID']."'
    and typecheckout.typeCheckOutID=checkinout.typeCheckOutID
    ...
    while ($row = mysqli_fetch_array($result)) {
            ...
            echo "<td ><font color='#003366'>" . $row["studentName"] . "&nbsp" . $row['studentLastname'] . "</font></td>";
            echo "<td align='center'><font color='#จจ0000'>" . $row["class"] . "</font></td>";
            echo "<td align='center'><font color='#จจ0000'>" . $row["typeCheckOut"] . "</font></td>";
            echo "</tr>";
