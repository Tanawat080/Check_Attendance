...
if (!$_SESSION["uname"]) {  //check session
    ...
    <?php echo($_SESSION['userID']); ?><br>
            ...
            <center>
                ...
                <hr><br>
                <div class="im">
                    <a href="ReportCheckInDaily.php" ><img src="images/image001.png" width="200" height="75"  ></a>	&nbsp;&nbsp;&nbsp;
                    <a href="ReportCheckOutDaily.php"><img src="images/image002.png" width="200" height="75" ></a>	&nbsp;&nbsp;&nbsp;
